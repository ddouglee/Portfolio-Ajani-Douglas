...
<h1>About Me</h1>
{/*Picture of Ajani: */}
<img src="Ajani Douglas.jpeg" alt="a photo of Ajani Douglas" width={108} height={116} style={{ float: 'left', marginRight: '20px' }}></img>
{/*Paragraph of me: */}
...
<a href="/Resume-Ajani Douglas.pdf" download="Resume-Ajani Douglas.pdf">
    My Resume
</a> 
</div>
);
